...
$query = "select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA = 'yarn_issues' order by create_time desc;";
...
if ($result = $mysqli->query($query)) {
	...
	echo '<tr><td><div class="intable"><a href="is/tableshow.php?Table='.$field1name.'&sb=date">'.$field1name.'</a></div></td> </tr>';
...
<br>
<button onclick="window.location.href = '/addnewis.php';">Add New Table</button>
