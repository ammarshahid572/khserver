...
include 'dbconfig.php';$database = "yarn_returns"; 
...
<h4><br> Sort By <a href="/rt/tableshow.php?Table=<?php echo $tn ?>&sb=date">Date</a>
			 <a href="/rt/tableshow.php?Table=<?php echo $tn ?>&sb=party">Party</a>
</h4>
<?php
echo '<tr><td><a href="/rt/addrec.php?Table='.$tn.'">Add New Record</a></td> </tr>';
?>
<div class="back"><h3>
<a href="/recieving.php">Back</a></h3></div>
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
		...
		echo '<tr><td>'.$field1name.'</td> 
				  ...
				  <td>'.$field5name.'</td>
				  <td>'.$field6name.'</td>
				  <td><div class="intable"><a href="/rt/delrec.php?id='.$field1name.'&tn='.$tn.'">Delete</a></div></td></tr>';
	}
    $result->free();
} 
?>
...
<br>
<div class="back"><h3>
<a href="/returns.php">Back</h3></a></div>
</div>
</body>
</html>